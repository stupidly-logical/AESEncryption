package com.example.stupid.aesencrypion.encyption;

/**
 * Created by Yash Krishan Verma on 19/8/17.
 */
 ...
 *
 * <p>
 * This cross platform CryptLib uses AES_ 256 for encryption. This library can
 * be used for encryptoion and de-cryption of string on iOS, Android and Windows
 * platform.<br/>
 * Features: <br/>
 * 1. 256 bit AES_ encryption
...
public class AES {
    ...
    public AES() throws NoSuchAlgorithmException, NoSuchPaddingException {
        // initialize the cipher with transformation AES_/CBC/PKCS5Padding
    ...
    private String encryptDecrypt(String _inputText, String _encryptionKey,
        ...
        //KeyGenerator _keyGen = KeyGenerator.getInstance("AES_");
        //_keyGen.init(128);

        SecretKeySpec keySpec = new SecretKeySpec(_key, "AES_"); // Create a new SecretKeySpec
        // for the
        // specified key
        // data and
        // algorithm
